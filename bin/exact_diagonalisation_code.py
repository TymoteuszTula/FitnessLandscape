...
def create_hamiltonian(states, params_input={}):
    ...
    for i in range(2 ** L):
        ...
        for j in range(j_max):
            ...
            res_z_temp1 = apply_op(states, "Sz", j % L, i)
            res_z_temp2 = apply_op(states, "Sz", (j + 1) % L, res_z_temp1[0])
            res_zz_temp = apply_op(states, "Sz", j % L, res_z_temp1[0])

            res.append((res_z_temp2[0], Jz * res_z_temp1[1] * res_z_temp2[1]))
            res.append((res_zz_temp[0], D * res_z_temp1[1] * res_zz_temp[1]))

            res_x_temp1 = apply_op(states, "Sx", j % L, i)
            res_x_temp2 = apply_op(states, "Sx", (j + 1) % L, res_x_temp1[0])
            res_xx_temp = apply_op(states, "Sx", j % L, res_x_temp1[0])

            res.append((res_x_temp2[0], Jx * res_x_temp1[1] * res_x_temp2[1]))
            res.append((res_xx_temp[0], E * res_x_temp1[1] * res_xx_temp[1]))

            res_y_temp1 = apply_op(states, "Sy", j % L, i)
            res_y_temp2 = apply_op(states, "Sy", (j + 1) % L, res_y_temp1[0])
            res_yy_temp = apply_op(states, "Sy", j % L, res_y_temp1[0])
        ...
        if bc == "finite":
            res_z_temp1 = apply_op(states, "Sz", L-1, i)
            res_zz_temp = apply_op(states, "Sz", L-1, res_z_temp1[0])
            res_x_temp1 = apply_op(states, "Sx", L-1, i)
            res_xx_temp = apply_op(states, "Sx", L-1, res_x_temp1[0])
            res_y_temp1 = apply_op(states, "Sy", L-1, i)
            res_yy_temp = apply_op(states, "Sy", L-1, res_y_temp1[0])
...
def create_hamiltonian_2(states, params_input={}):
    ...
    for i_row in range(2 ** L):
        ...
        for i in range(j_max):
            ...
            res_z_temp = apply_op(states, "Sz", i % L, i_row)
            res_x_temp = apply_op(states, "Sx", i % L, i_row)
            res_y_temp = apply_op(states, "Sy", i % L, i_row)
            ...
            for j in range(j_max):
                ...
                res_zz_temp = apply_op(states, "Sz", j % L, res_z_temp[0])
                res_xz_temp = apply_op(states, "Sx", j % L, res_z_temp[0])
                res_yz_temp = apply_op(states, "Sy", j % L, res_z_temp[0])

                res_zx_temp = apply_op(states, "Sz", j % L, res_x_temp[0])
                res_xx_temp = apply_op(states, "Sx", j % L, res_x_temp[0])
                res_yx_temp = apply_op(states, "Sy", j % L, res_x_temp[0])

                res_zy_temp = apply_op(states, "Sz", j % L, res_y_temp[0])
                res_xy_temp = apply_op(states, "Sx", j % L, res_y_temp[0])
                res_yy_temp = apply_op(states, "Sy", j % L, res_y_temp[0])
